...
* Understand how MQTT protocol works
* Set up a local MQTT broker using Mosquitto
* Configure ESP32 to publish sensor data to MQTT topics
* Monitor published data using MQTT client tools (used MQTT explorer)
* Organise MQTT topic hierarchy for multiple sensor types
* Ensure data transmission stability and timing
* Set up a flask web server on local machine
